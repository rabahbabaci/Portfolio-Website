...
export const HireMe = () => {
  return (
    <div className='fixed left-4 bottom-4 flex flex-col items-center justify-center md:right-4 sm:right-0 overflow-hidden md:bottom-auto md:left-auto md:top-0 md:absolute z-20 rounded-full '>
